  ...
  return (
    <Nav ref={navRef} aria-label="Global Navigation">
      ...
      <Content>
        ...
        <p class="myname" ><Link to="/">{title}</Link></p>
        <p> 
    <a className="social-link linkedin" href="https://www.linkedin.com/in/sylvainbruas/" target="_blank" rel="noopener noreferrer" title="linkedin" >
      <FaLinkedin className="social-icon" size="32" />
    </a>
      <a className="social-link github" href="https://github.com/sylvainbruas/" target="_blank"  rel="noopener noreferrer"  title="github">
      <FaGithub className="social-icon" size="32" />
    </a>
    <a   className="social-link twitter"   href="https://twitter.com/sylvain_bruas"  target="_blank"  rel="noopener noreferrer" title="twitter" >
      <FaTwitter className="social-icon" size="32" />
    </a>
    <a className="social-link email"    href="https://calendly.com/sylvain-bruas"  target="_blank" rel="noopener noreferrer"  title="contact me " >
      <FaEnvelope className="social-icon" size="32" />
    </a>
    <a   className="social-link Badge"   href="https://www.credly.com/users/sylvain-bruas/badges"  target="_blank"  rel="noopener noreferrer"  title="credly" >
      <BiBadgeCheck className="social-icon" size="32" />
    </a>
    <a   className="social-link Badge"   href="/rss.xml"  target="_blank"  rel="noopener noreferrer"  title="credly" >
     <FaRss className="social-icon" size="32" />
     </a>
        </p>
        </Title>
        <LinkWrap>
